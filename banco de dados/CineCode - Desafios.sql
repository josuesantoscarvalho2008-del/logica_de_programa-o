...
-- Mostre o título e o ano de lançamento.
 ...
 select titulo, ano_lancamento, genero from filmes where genero = 'Drama';
...
select * from filmes order by preco_aluguel desc limit 5;
...
update filmes set preco_aluguel = 1.50 where ano_lancamento = 2001 and genero = 'Comédia';
select * from filmes where ano_lancamento = 2001 and genero = 'Comédia';
-- =============================================================================
...
-- Correção:
#faltava 0 > entre ano_lancamento e 2005
...
# no que estava escrito estado era para estar escrito regiao
