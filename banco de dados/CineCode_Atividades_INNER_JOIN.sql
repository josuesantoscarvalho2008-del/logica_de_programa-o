...
FROM
    atores AS a
        INNER JOIN
    atuacoes AS at ON a.id_ator = at.id_ator
        INNER JOIN
    filmes AS f ON f.id_filme = at.id_filme;
...
FROM
    filmes AS f
        INNER JOIN
    atuacoes AS at ON at.id_filme = f.id_filme
        INNER JOIN
    atores AS a ON a.id_ator = at.id_ator
...
FROM
    filmes AS f
        INNER JOIN
    alugueis AS a ON a.id_filme = f.id_filme
        INNER JOIN
    clientes AS c ON c.id_cliente = a.id_cliente
